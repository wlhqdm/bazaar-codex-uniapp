...
EVENT_ZH = {
    ...
    "Ahexa": "阿赫克萨",
    "Aleppa Tantius": "阿莱帕·坦提乌斯",
    "Awakened District": "觉醒街区",
    "Banannibal": "香蕉尼拔",
    "Boarrior": "野猪勇士",
    "Boilerroom Brawler": "锅炉房打手",
    "Burninator Bot": "焚化机甲",
    "Chilly Charles": "寒意查尔斯",
    "Cloudtop Officer": "云顶军官",
    "Cosmic Roc": "宇宙大鹏",
    "Dabbling Apprentice": "涉猎学徒",
    "Dire Inglet": "凶恶小怪",
    "Dire Mosquito": "凶恶蚊子",
    "Dooltron": "多尔王",
    "Dr. Vortex": "涡流博士",
    "Dragon": "巨龙",
    "Eccentric Etherwright": "古怪以太工匠",
    "Fanged Inglet": "獠牙小怪",
    "Foreman": "工头",
    "Foundation Revenant": "基座亡灵",
    "Foundation Weeper": "基座泣者",
    "Giant Mosquito": "巨型蚊子",
    "Gorgon Noble": "戈耳工贵族",
    "Grandfather Klok": "克洛克爷爷",
    "Greenheart Guardian": "绿心守卫",
    "Harkuvian Rocket Trooper": "哈库维火箭步兵",
    "Haunted Kimono": "闹鬼和服",
    "Hellbilly": "地狱乡巴佬",
    "Hulking Experiment": "庞大实验体",
    "Infernal": "炼狱者",
    "Infernal Dreadnought": "炼狱无畏舰",
    "Infernal Envoy": "炼狱使者",
    "Joyful Jack": "欢乐杰克",
    "Kyver Commander": "凯弗指挥官",
    "Lich": "巫妖",
    "Lord Arken": "阿肯领主",
    "Mimic": "拟态怪",
    "Mod Squad": "改装小队",
    "Mythkeeper": "神话守护者",
    "Oasis Guardian": "绿洲守卫",
    "Product Demonstrator": "产品演示员",
    "Property Baron": "地产大亨",
    "Qomatz": "科马兹",
    "Retiree": "退休者",
    "Rogue Scrapper": "流浪拆卸工",
    "Sabretooth": "剑齿虎",
    "Sandwich Artist": "三明治大师",
    "Scovyle": "斯科维尔",
    "Sergeant Suds": "泡沫中士",
    "Stew": "炖菜",
    "Street Gamer": "街头玩家",
    "Test Subject Alpha": "实验体阿尔法",
    "Thug": "暴徒",
    "Trash Titan": "垃圾泰坦",
    "Trashtown Mayor": "垃圾镇镇长",
    "Viper": "毒蛇",
    "Viper Tyrant": "毒蛇暴君",
    "Void Colossus": "虚空巨像",
    "Void Golem": "虚空魔像",
...
def translate_shop_name(name: str) -> str:
    return SHOP_ZH.get(name, name)
